...
class ControllerExtensionModuleStarter extends Controller {
	...
	public function index() {   
		...
		if (isset($this->error['variable'])) {
			$data['error_variable'] = $this->error['field'];
		} else {
			$data['error_variable'] = '';
		}
		...
		if (isset($this->request->post['variable'])) {
			...
			$data['variable'] = $module_info['variable'];
		} else {
			$data['variable'] = '';
		}
	...
	private function validate() {
		...
		if ((utf8_strlen($this->request->post['variable']) < 3) || (utf8_strlen($this->request->post['variable']) > 64)) {
			$this->error['variable'] = $this->language->get('error_field');
		}
